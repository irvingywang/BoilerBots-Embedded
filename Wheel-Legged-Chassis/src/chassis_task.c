...
void Chassis_Kinematics_Update()
{
    ...
    Two_Bar_Forward_Kinematics(&g_left_leg_kinematics, g_chassis_motor[0]->stats->pos, g_chassis_motor[1]->stats->pos);
}
...
void Chassis_Ctrl_Loop()
{
    ...
    if (g_remote.controller.right_switch == MID) // Open Loop VMC (Debug Only)
    {
        ...
        DM_Motor_Ctrl_MIT_PD(g_chassis_motor[0], 0.0f, 0.0f, left_motor_torque.torque1, 0.0f, 0.0f);
        DM_Motor_Ctrl_MIT_PD(g_chassis_motor[1], 0.0f, 0.0f, left_motor_torque.torque2, 0.0f, 0.0f);
        ...
        DM_Motor_Ctrl_MIT_PD(g_chassis_motor[2], 0.0f, 0.0f, right_motor_torque.torque1, 0.0f, 0.0f);
        DM_Motor_Ctrl_MIT_PD(g_chassis_motor[3], 0.0f, 0.0f, right_motor_torque.torque2, 0.0f, 0.0f);
    }
